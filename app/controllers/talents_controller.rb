class TalentsController < ApplicationController
  ...
  private
    ...
    def talent_params
      params.require(:talent).permit(:username, :first_name, :middle_name, :last_name, :biography, :phone, :address, :address2, :city, :state, :zipcode, :sex, :birthday, :government_id, :topsuit, :waisthip, :pantlength, :eyecolor, :has_visible_tattoo, :booking_id)
    end
end
